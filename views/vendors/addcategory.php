...
$postUrl = CommonUtility::getUrl(Yii::getAlias('@web') . '/vendors/addcategory', [
                ...
                <?php foreach ($properties as $key => $property) { ?>
                    <?php if($property['category_data_type'] == 'T') { ?>
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" name="property_<?= CommonUtility::getFieldName($property['property_id'])?>" value=""/>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <?php foreach ($options as $value) { ?>
                            <label class="custom-check">
                              <input type="radio" id="option_<?= $value ?>" name="property_<?= CommonUtility::getFieldName($property['property_id'])?>" value="<?= $value ?>"/>
                    ...
                    <?php } else if ($property['category_data_type'] == 'I') { ?>
                        <div class="form-group">
                          <label class="control-label"><?= $property->category_property ?></label>
                          <input class="form-control" type="number" name="property_<?= CommonUtility::getFieldName($property['property_id'])?>" value=""/>
                        </div>
                    <?php } else if ($property['category_data_type'] == 'D') { ?>
                        <div class="form-group">
                          <label class="control-label"><?= $property->category_property ?></label>
                          <input class="form-control" type="number" name="property_<?= CommonUtility::getFieldName($property['property_id'])?>" value=""/>
                        </div>
